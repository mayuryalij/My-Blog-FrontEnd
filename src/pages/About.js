...
const About = () => {
  return (
    <div className="mb-20 ">
      ...
      <p className="font-bold">A blog is a website or page that is a part of a larger website. Typically, it features articles written in a conversational style with accompanying pictures or videos.
       <br/>
